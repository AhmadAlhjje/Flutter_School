...
تطبيق Android و iOS للطلاب: إنشاء حساب من داخل التطبيق، ثم المواد (بدون صفوف: كل مادة بطاقة
بعرض الشاشة، المفتوحة أولاً) ← المدرسين ← الدروس المرقّمة ← الجلسات، والفيديوهات والملفات في كل
جلسة (تبويبان). التحميل للمشاهدة بدون إنترنت صالح لسنة كاملة، ويبقى الفيديو في مكانه داخل الجلسة
(وعند عدم الاتصال تظهر التحميلات مرتبة حسب المادة والأستاذ). شريط سفلي: الرئيسية، بحث، الإشعارات،
حسابي. عربي افتراضياً مع الإنجليزية.
