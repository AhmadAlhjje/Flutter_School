...
تشغيل الفيديو: 0.5x و 1x و 1.5x و 2x. التحميل للمشاهدة بدون إنترنت صالح لسنة كاملة، ويبقى الفيديو في مكانه داخل الجلسة
(وعند عدم الاتصال تظهر التحميلات مرتبة حسب المادة والأستاذ). شريط سفلي: الرئيسية، بحث، الإشعارات،
حسابي. بالعربية فقط في النسخة الأولى (الترجمة الإنجليزية موجودة ومخفية؛ لإظهارها: `englishEnabled = true` في
